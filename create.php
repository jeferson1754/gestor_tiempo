...
<head>
    ...
    <title>Agregar Producto/Servicio</title>
                        ...
                        <form method="POST" id="productForm">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="tipo" name="tipo" required>
                                            ...
                                            <option value="producto" <?php echo (isset($producto->tipo) && $producto->tipo == 'producto') ? 'selected' : ''; ?>>
                                                Producto
                                            </option>
                                            <option value="servicio" <?php echo (isset($producto->tipo) && $producto->tipo == 'servicio') ? 'selected' : ''; ?>>
                                                Servicio
                                            </option>
                                        </select>
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="descripcion" name="descripcion" rows="3" 
                                          placeholder="Descripción detallada del producto o servicio"><?php echo isset($producto->descripcion) ? htmlspecialchars($producto->descripcion) : ''; ?></textarea>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" id="fecha_inicio" name="fecha_inicio" 
                                               value="<?php echo isset($producto->fecha_inicio) ? $producto->fecha_inicio : ''; ?>" 
                                               required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" id="fecha_fin" name="fecha_fin" 
                                               value="<?php echo isset($producto->fecha_fin) ? $producto->fecha_fin : ''; ?>" >
                                    </div>
                                </div>
                            </div>

                            <div id="diferencia-preview" class="alert alert-info" style="display: none;">
                                <i class="fas fa-clock me-2"></i>
                                <span id="diferencia-text"></span>
                            </div>
            ...
            if (fechaInicio && fechaFin) {
                ...
                if (fin > inicio) {
                    ...
                    document.getElementById('diferencia-text').innerHTML = 
                        `<strong>Diferencia:</strong> ${diffString || '0 días'}`;
                    document.getElementById('diferencia-preview').style.display = 'block';
                } else {
                    document.getElementById('diferencia-preview').style.display = 'none';
                }
            } else {
                document.getElementById('diferencia-preview').style.display = 'none';
            }
